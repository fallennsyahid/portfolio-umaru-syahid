...
const modalEl5 = document.getElementById('info-popup5');
...
const closeModalEl5 = document.getElementById('close-modal5');
...
const openModalEl5 = document.getElementById('open-modal5');
...
function showModal5() {
    modalEl5.classList.remove('hidden');
}
...
openModalEl5.addEventListener('click', function (event) {
    event.preventDefault(); // Mencegah default action dari link
    showModal5();
});
...
closeModalEl5.addEventListener('click', function () {
    hideModal5();
});